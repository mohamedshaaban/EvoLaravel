...
use App\User;
use App\Models\AddedVenue;

class AddedVenueController extends Controller
{
...
//		});
	...
	{
		$show = new Show(AddedVenue::findOrFail($id));
